...
```bash
# 通过命令行参数
npx @benbenwu/zcf --lang zh-CN
npx @benbenwu/zcf init --lang zh-CN

# 通过统一语言参数（推荐）
npx @benbenwu/zcf --all-lang zh-CN
...
```bash
# 初始化时设置
npx @benbenwu/zcf init --ai-output-lang zh-CN

# 或使用统一参数
npx @benbenwu/zcf init --all-lang zh-CN
...
npx @benbenwu/zcf init --lang zh-CN --config-lang en

# 英文界面 + 中文模板（适合国际化团队）
npx @benbenwu/zcf init --lang en --config-lang zh-CN
...
```bash
# 初始化时设置
npx @benbenwu/zcf init --config-lang zh-CN

# 更新时设置
npx @benbenwu/zcf update --config-lang zh-CN
...
```bash
# Codex 初始化，使用中文
npx @benbenwu/zcf init -T codex --all-lang zh-CN
...
```bash
npx @benbenwu/zcf init --lang zh-CN --ai-output-lang en --config-lang zh-CN
```
...
```bash
npx @benbenwu/zcf init --lang en --config-lang en --ai-output-lang en
```
...
# 或团队统一使用英文
npx @benbenwu/zcf init --all-lang en
```
...
# 混合项目：中文界面 + 英文输出
npx @benbenwu/zcf init --lang zh-CN --ai-output-lang en
```
...
# 2. 切换到英文，更新文档
npx @benbenwu/zcf update --config-lang en
# 生成英文版本的文档
